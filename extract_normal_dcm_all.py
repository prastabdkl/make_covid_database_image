...
for i in range(1,folder_count+1):
    image_count = 1
    folder_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\Normal_dcm\normal'+f'{str(i).zfill(3)}' 
    # output_folder_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\output\normal\P'+f'{str(i)}'
