...
directory_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\Normal_dcm' 
result_folder = r"C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\output\normal"
...
for i in range(1, folder_count+1):
    ...
    jpg_folder_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\Normal_dcm\normal'+f'{str(i).zfill(3)}' 
    ...
    for j in range(1, file_count+1):
        img_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\Normal_dcm\normal'+f'{str(i).zfill(3)}'+'\Covid_'+f'{str(j)}.jpg' 
    ...
    cv2.imwrite(result_folder+'/Normal_'+f'{str(image_count)}.jpg', max_image_area)
    image_count += 1
