...
jpg_folder_path = r"C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\common"

image_count = 1
for i in range(1,169):
    folder_path = r'C:\Users\prast\Downloads\CS 7000\Final report\COVID-CT-MD\Cap Cases\cap'+f'{str(i).zfill(3)}' 
